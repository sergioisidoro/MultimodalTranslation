...
addpath('../Data/libraries/MOCAP_manchester');
addpath('../Data/libraries/MOCAP_manchester/NDLUTIL0p161');
addpath('../Data/helper_functions');

%% Load motion data and precalculated features

load('../Data/motion_data_and_normalized_features.mat');
...
%% Method of KNN classification for translation.


% Assembling the matrix for KNN classification

sample = video_coordinates;
