function klausSkelPlayData(skelStruct, channels, frameLength, classification_text, classes, real_classes, folder)
...
for j = 1:size(channels, 1)
  pause(frameLength)
  klausSkelModify(handle, channels(j, :), skelStruct, classification_text{j}, real_classes{j});
end
